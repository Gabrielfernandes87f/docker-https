    ...
    <div class="bloco-show col-md-10 offset-md-1">
        <div class="row">
            <div id="image-container" class="col-md-6">
                <img src="/image/image1.jpeg" class="img-fluid" alt="foto01">
            </div>
            <div id="infor-container" class="col-md-6">
                <h1 class="h1-show-title">Cond. Campos do conde</h1>
                <p class="event-city">
            ...
            <div class="col-md-12" id="description-container">
                ...
                <p class="event-description">descrição: rolê no condminio Campos do conde. Òtimo pra quem gosta de ladeira. a paisagem também é muito bonita</p>
            </div>
        </div>
    </div>
