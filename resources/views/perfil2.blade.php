    ...
    <div class="bloco-show col-md-10 offset-md-1">
        <div class="row">
            <div id="image-container" class="col-md-6">
                <img src="/image/image2.jpeg" class="img-fluid" alt="foto02">
            </div>
            <div id="infor-container" class="col-md-6">
                <h1 class="h1-show-title">Parque de bodocongo</h1>
                <p class="event-city">
            ...
            <div class="card-date card-date-show"><strong> Data do vento:</strong> 20/10/2020</div>
            <div class="col-md-12" id="description-container">
                <h3> Sobre o evento</h3>
                <p class="event-description">descrição: Paque de bodocongo. Era um ótimo lugar pra se divertir, pra quem gosta de andar de patins, nossa Cidade não oferece muitos lugares. O parque era muito bom. mas agora se encontra fechado desde o início da pandemia</p>
            </div>
        </div>
    </div>
